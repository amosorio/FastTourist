...
public class PaseoControlador {
	...
	/**
	 * Controlador de la pantalla de ver informacion detallada de servicio de paseo ecologico	 * 
	 * @param id
	 * @param model
	 * @return
	 */
	...
	public ModelAndView getPaseo(@PathVariable("id")int id, ModelMap model){
		...
		String result = restTemplate.getForObject("http://localhost:8080/logica/paseo/get/" + id, String.class);
		try {
